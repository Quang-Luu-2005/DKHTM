...
\begin{frame}{Nội dung trình bày}
  ...
  \begin{enumerate}
    ...
    \item Mô tả bài toán
    \item Góc nhìn điều khiển thiết bị thông minh
    \item Kiến trúc hệ thống
    \item Công nghệ tái tạo khuôn mặt 3D
  \end{enumerate}
\end{frame}
...
%============================
\section{Góc nhìn điều khiển thiết bị thông minh}
%============================
...
%============================
\section{Công nghệ tái tạo khuôn mặt 3D}
%============================
...
\begin{frame}{Pipeline xử lý AI -- Hậu xử lý \& Xác thực}
  \small
  \begin{columns}[T]
    \column{0.48\textwidth}
      ...
      \]
      \begin{itemize}
        \item Loại bỏ nhiễu răng cưa trên bề mặt
        \item Giữ nguyên cấu trúc tổng thể khuôn mặt
        \item Mesh mịn $\to$ so khớp chính xác hơn
      \end{itemize}
    ...
    \column{0.48\textwidth}
      ...
      $\text{sim}(\alpha_{\text{id}}^{\text{input}},\; \alpha_{\text{id}}^{\text{DB}}) \geq \theta$\\[3pt]
      $\to$ \texttt{PASS} (mở cửa)\\
      $< \theta$ $\to$ \texttt{DENY} (từ chối)
  \end{columns}
\end{frame}
