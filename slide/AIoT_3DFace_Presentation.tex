...
\begin{frame}{Related Work -- Vì sao chọn MVFNet?}
  \scriptsize
  \setlength{\tabcolsep}{4pt}
  \renewcommand{\arraystretch}{1.2}
  \begin{tabular}{p{0.16\textwidth}p{0.27\textwidth}p{0.27\textwidth}p{0.21\textwidth}}
    \toprule
    \textbf{Giải pháp} & \textbf{Mục tiêu chính} & \textbf{Ưu / nhược với đồ án} & \textbf{Kết luận} \\
    \midrule
    \textbf{3DDFA-V2} \cite{3ddfav2}
      & Dense face alignment, ước lượng pose và landmark 3D.
      & Nhanh, ổn định; output nghiêng về căn chỉnh hơn xác thực danh tính.
      & Không chọn làm lõi. \\
    \textbf{DECA} \cite{deca}
      & Tái tạo khuôn mặt 3D chi tiết, biểu cảm và texture.
      & Kết quả đẹp; mô hình nặng hơn, thiên về animation/detail.
      & Tham khảo phần texture. \\
    \textbf{Deep3DFace} \cite{deep3dface}
      & Tái tạo 3DMM từ một ảnh khuôn mặt.
      & Nền tảng tốt; cần gắn thêm matching, log và điều khiển thiết bị.
      & Dùng làm baseline. \\
    \textbf{MVFNet} \cite{mvfnet}
      & Hồi quy tham số 3DMM đa góc nhìn, có vector identity $\alpha_{\text{id}}$.
      & Cân bằng giữa mesh 3D, đặc trưng nhận dạng và độ phức tạp.
      & Chọn làm lõi. \\
    \bottomrule
  \end{tabular}
  ...
  \vspace{0.5em}
  \textbf{Kết luận:}
  MVFNet phù hợp nhất vì đồ án cần vector khuôn mặt 3D để so khớp danh tính, còn phần xử lý nặng vẫn chạy trên laptop/server.
\end{frame}
...
\begin{frame}{Tài liệu tham khảo}
  ...
  \begin{thebibliography}{99}
    ...
    \bibitem{3ddfav2} J. Guo \textit{et al.}, ``Towards Fast, Accurate and Stable 3D Dense Face Alignment,'' \textit{ECCV}, 2020.
    \bibitem{deca} Y. Feng \textit{et al.}, ``Learning an Animatable Detailed 3D Face Model from In-the-Wild Images,'' \textit{SIGGRAPH}, 2021.
    \bibitem{deep3dface} Y. Deng \textit{et al.}, ``Accurate 3D Face Reconstruction with Weakly-Supervised Learning,'' \textit{ICCV Workshops}, 2019.
